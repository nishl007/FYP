...
import Item1 from "../../assets/biryani3.png";
import Item2 from "../../assets/coffee.png";
import Item3 from "../../assets/biryani5.png";
...
const Hero = () => {
  const [imageId, setImageId] = React.useState(Item1);
            ...
            <div className="min-h-[450px] sm:min-h-[450px] flex justify-center items-center relative order-1 sm:order-2 ">
              <div className="h-[300px] sm:h-[450px] overflow-hidden flex justify-center items-center">
                <img
                  ...
                  src={imageId}
                  alt="biryani img"
                  className="w-[250px] sm:w-[450px] sm:scale-125  mx-auto spin "
                />
              </div>
